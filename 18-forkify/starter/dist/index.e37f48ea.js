...
const controlPagination = function(page) {
    _resultViewJsDefault.default.render(_modelJs.getSearchResultPage(page));
    _paginationViewJsDefault.default.render(_modelJs.state.search);
};
...
},{"core-js/modules/web.immediate":"49tUX","./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultView.js":"f70O5","./views/paginationView.js":"6z7bi","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/bookmarksView":"4Lqzq"}],"49tUX":[function(require,module,exports) {
...
},{"./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"awG7q":[function(require,module,exports) {
...
class RecipeView extends _viewJsDefault.default {
    ...
    _errorMessage = "No recipe found with the id: ";
    _message = "";
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener("click", function(e) {
            ...
            if (!btn) return;
            // console.log("updateServings called -- btn");
...
},{"url:../../img/icons.svg":"loVOp","fractions":"awG7q","./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"loVOp":[function(require,module,exports) {
        ...
        const markup = `
            <div class="error">
                <div>
                    <svg>
                        <use
                            href="${_iconsSvgDefault.default}#icon-alert-triangle"
                        ></use>
                    </svg>
                </div>
                <p>${message}</p>
        ...
        const markup = `
            <div class="message">
                <div>
                    <svg>
                        <use
                            href="${_iconsSvgDefault.default}#icon-smile"
                        ></use>
                    </svg>
                </div>
                <p>${message1}</p>
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView":"1FDQ6"}]},["kGakq","aenu9"], "aenu9", "parcelRequire3a11")
